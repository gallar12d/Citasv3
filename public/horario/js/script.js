...
var pmes =  new Date(curr.setDate(first)).getMonth();
var smes =  new Date(curr.setDate(last)).getMonth();
// alert(pmes);
// alert(smes);
...
var pdia = firstday + " de " + meses[pmes] + " de " + f.getFullYear();
var udia = lastday+ " de " + meses[smes] + " de " + f.getFullYear();
