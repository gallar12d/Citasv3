...
<div class="panel panel-blue">
 <div class="panel-heading">Crear Empresa</div>
   <div class="panel-body pan">
    ...
    {!! Form::open(['route' => 'empresa.store', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal form-seperated form-row-stripped']) !!}
    ...
    <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
      <div class="form-body">
        ...
        <div class="form-group">
         ...
         <div class="col-md-4">
         <input id="direccion" name="direccion" type="text" placeholder="Dirección Empresa" class="form-control"/>
         </div>
        </div>
        <div class="form-group">
         ...
         <div class="col-md-4">
         <input id="ruc" name="ruc" type="text" placeholder="Ruc" class="form-control"/>
         </div>
        </div>
